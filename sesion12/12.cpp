...
int main(){
   ...
   cout << "Introduce el numero de la primera posicion seguido de la ultima posicion: "; 
   int primera_posicion = LeeIntMayorIgualQue(0);
   int ultima_posicion = LeeIntRango(primera_posicion, secuencia.TotalUtilizados());

   secuencia.EliminaBloque(primera_posicion, ultima_posicion);
