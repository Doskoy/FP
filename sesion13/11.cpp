...
public:
   ...
   */
   ...
   SecuenciaDoubles kmayores (int k, int referencia) {
      SecuenciaDoubles mayores_que;

      for (int i = 0; i < total_utilizados; i++){
      double a_insertar = vector_privado[i];
      int j;
      ...
      if (a_insertar >= referencia){
         ...
         if (mayores_que.TotalUtilizados() >= k)
            mayores_que.Elimina(mayores_que.TotalUtilizados());
         ////////////////////////////////////////////////////////////////////////////////////
         //Hay que probar el codigo, que esta sin probar :D
         /////////////////////////////////////////////////////////////////////////////////////////
      }
   }
...
int main(){
   ...
   SecuenciaDoubles k_mayores;
   int k, referencia;

   cout << "Introduce el vector de numeros\n"; 
   ...
   cout << "Introduce el tamaño de referencia: ";
   cin >> referencia;

   secuencia.kmayores(k, referencia) = k_mayores;

   cout << "\n" << "Secuencia: " << k_mayores.Elemento(0); /*k_mayores.ToString()*/;
