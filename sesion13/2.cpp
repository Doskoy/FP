//No he conseguido encontrar el error por el que no funciona correctamente :(
...
public:
                  ...
                  double longitud_radio)
   {
	...
	SegmentoDirigido SegmentoRadio(){
		SegmentoDirigido segmento_radio(centro.abscisa, centro.ordenada, centro.abscisa, centro.ordenada + Longitud());
...
int main(){
	...
	bool esta_dentro;
	//SegmentoDirigido segmento_radio(0,0,0,0);
   ...
   cin >> punto.ordenada;
	...
	area        = circunf.Area();
	longitud_segmento_radio = (circunf.SegmentoRadio()).Longitud();
	

   cout << "\n\nLongitud: 				" << longitud;
   cout << "\nÁrea:       				" << area;
   cout << "\nLongitud segmento_radio:	" << longitud_segmento_radio << endl;
